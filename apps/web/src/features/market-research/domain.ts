...
export const DEPTH_CONFIG: Record<ResearchDepth, DepthConfig> = {
  QUICK: {
    label: '簡易',
    description: '各ECサイト10件で素早く傾向を掴む(約1分)。AI競合分析は省略します。',
    perSourceLimit: 10,
    aiProductCap: 10,
  ...
  STANDARD: {
    label: '標準',
    description: '各ECサイト30件を取得し、AIによる競合分析まで行う標準的な調査。',
    perSourceLimit: 30,
    aiProductCap: 20,
  ...
  DEEP: {
    label: '詳細',
    description: '各ECサイト60件まで取得して網羅し、完了後にレビュー解析まで自動実行します(時間がかかります)。',
    perSourceLimit: 60,
    aiProductCap: 30,
    runCompetitorAnalysis: true,
