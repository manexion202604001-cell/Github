...
CREATE TYPE "public"."lesson_type" AS ENUM('video', 'slide', 'text', 'quiz');--> statement-breakpoint
CREATE TYPE "public"."progress_status" AS ENUM('not_started', 'in_progress', 'completed');--> statement-breakpoint
CREATE TYPE "public"."qa_status" AS ENUM('open', 'answered', 'resolved');--> statement-breakpoint
CREATE TYPE "public"."reaction_kind" AS ENUM('clap', 'idea', 'thanks', 'fire');--> statement-breakpoint
...
ALTER TABLE "channel_follows" ADD CONSTRAINT "channel_follows_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "courses" ADD CONSTRAINT "courses_created_by_profiles_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "lesson_notes" ADD CONSTRAINT "lesson_notes_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "office_hour_attendance" ADD CONSTRAINT "office_hour_attendance_office_hour_id_office_hours_id_fk" FOREIGN KEY ("office_hour_id") REFERENCES "public"."office_hours"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_hour_attendance" ADD CONSTRAINT "office_hour_attendance_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_hour_question_votes" ADD CONSTRAINT "office_hour_question_votes_question_id_office_hour_questions_id_fk" FOREIGN KEY ("question_id") REFERENCES "public"."office_hour_questions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_hour_question_votes" ADD CONSTRAINT "office_hour_question_votes_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_hour_questions" ADD CONSTRAINT "office_hour_questions_office_hour_id_office_hours_id_fk" FOREIGN KEY ("office_hour_id") REFERENCES "public"."office_hours"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_hour_questions" ADD CONSTRAINT "office_hour_questions_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "qa_replies" ADD CONSTRAINT "qa_replies_thread_id_qa_threads_id_fk" FOREIGN KEY ("thread_id") REFERENCES "public"."qa_threads"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "qa_replies" ADD CONSTRAINT "qa_replies_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "qa_threads" ADD CONSTRAINT "qa_threads_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "qa_threads" ADD CONSTRAINT "qa_threads_course_id_courses_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."courses"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "qa_threads" ADD CONSTRAINT "qa_threads_lesson_id_lessons_id_fk" FOREIGN KEY ("lesson_id") REFERENCES "public"."lessons"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "xp_events" ADD CONSTRAINT "xp_events_action_xp_rules_action_fk" FOREIGN KEY ("action") REFERENCES "public"."xp_rules"("action") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "lesson_progress_user_updated" ON "lesson_progress" USING btree ("user_id","updated_at");--> statement-breakpoint
CREATE INDEX "notifications_user_read_created" ON "notifications" USING btree ("user_id","read_at","created_at" desc);--> statement-breakpoint
